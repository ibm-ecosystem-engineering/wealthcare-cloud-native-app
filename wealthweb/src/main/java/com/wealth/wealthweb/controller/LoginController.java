...
import com.wealth.wealthweb.model.LoginInfo;
import com.wealth.wealthweb.model.User;
import com.wealth.wealthweb.service.LoginService;
...
public class LoginController {
    ...
    private Object doLogin(@RequestBody LoginInfo loginInfo) {
        System.out.println("LoginController doLogin 1---> " + loginInfo);

        Object result = service.processLogin(loginInfo);
        System.out.println("LoginController doLogin 2---> " + result);
    ...
    private User getLoginUserName() {
        ...
        System.out.println("MyController loginUserName ---> " + username);
